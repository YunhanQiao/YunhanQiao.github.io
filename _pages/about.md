...
<div class="rq-grid">
  ...
  <div class="rq-card">
    ...
    <div class="rq-card-body">
      <div class="rq-image">
        <img src="/images/RQ2-procedure.png" alt="RQ2 Participant Flow and Per-Participant Procedure">
      </div>
      <div class="rq-content">
          ...
          <ul>
            <li>
              ...
              <span class="paper-info">
                ...
                <span class="paper-venue">SIGCSE 2027 &mdash; <strong>Under Submission</strong></span>
              </span>
            </li>
            <li>
              <i class="fas fa-file-pdf"></i>
              <span class="paper-info">
                <a href="https://dl.acm.org/doi/pdf/10.1145/3702652.3744219">The Effects of GitHub Copilot on Computing Students' Programming Effectiveness, Efficiency, and Processes in Brownfield Coding Tasks</a>
        ...
        <div class="rq-papers">
          ...
          <ul>
            <li>
              <i class="fas fa-file-pdf"></i>
              <span class="paper-info">
                <a href="#">Unraveling the Codebase: Exploring GenAI Adoption for Program Comprehension Among Expert Developers in Brownfield Programming Tasks</a>
                <span class="paper-venue">ICSE 2027 &mdash; <strong>Under Submission</strong></span>
              </span>
            </li>
          </ul>
        </div>
        ...
        <div class="rq-papers">
          ...
          <ul>
            <li>
              <i class="fas fa-file-pdf"></i>
              <span class="paper-info">
                <a href="#">Teaching GenAI-Assisted Software Development in Computing Education: An Experimental Study</a>
                <span class="paper-venue">SIGCSE 2027 &mdash; <strong>Under Submission</strong></span>
              </span>
            </li>
          </ul>
